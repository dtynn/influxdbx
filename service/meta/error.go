...
var (
	// ErrNodeIDRequired id is required to identify exist node
	ErrNodeIDRequired = errors.New("node id required")

	// ErrNodeNotFound node not found in the cluster
	ErrNodeNotFound = errors.New("node not found")

	// ErrMetaNodeExists meta node id exists in the cluster
	ErrMetaNodeExists = errors.New("meta node exits")

	// ErrDataNodeExists data node id exists in the cluster
	ErrDataNodeExists = errors.New("data node exits")
)
